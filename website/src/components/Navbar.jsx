...
import { Trophy, Github, FileText, Scale, Sun, Moon, Menu, X, BookOpen, Package, BarChart3 } from 'lucide-react'
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-3 group">
            <div className="relative">
              <Scale className={`w-8 h-8 transition-all duration-300 group-hover:scale-110 ${
